...
public class HTTPRedirectDeflateEncoder extends BaseSAML2MessageEncoder {
    ...
    protected String buildRedirectURL(SAMLMessageContext messagesContext, String endpointURL, String message)
        ...
        if (signingCredential != null) {
            // pull SecurityConfiguration from SAMLMessageContext? needs to be added
            String sigAlgURI = messagesContext.getSignatureMethod();
            if((sigAlgURI == null) || sigAlgURI.equals(""))
                sigAlgURI = getSignatureAlgorithmURI(signingCredential, null);
