...
public class BasicSAMLMessageContext<InboundMessageType extends SAMLObject, OutboundMessageType extends SAMLObject, NameIdentifierType extends SAMLObject>
    ...
    @Override
    public void setSignatureMethod(String signMethod) {
        signatureMethod = DatatypeHelper.safeTrimOrNullString(signMethod);
    }

    @Override
    public void setDigestMethod(String dMethod) {
        digestMethod = DatatypeHelper.safeTrimOrNullString(dMethod);
    }
